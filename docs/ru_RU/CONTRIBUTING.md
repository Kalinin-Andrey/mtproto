...
[english](https://github.com/Kalinin-Andrey/mtproto/blob/main/.github/CONTRIBUTING.md) **русский**
...
А еще мы вообще-то хотим сделать [ЧеКаво](https://github.com/Kalinin-Andrey/mtproto/discussions/categories/q-a), но не знаем, какие вопросы туда писать, так что, если вы это читаете, наверное, пишите пока в телегу, там разберемся :)
